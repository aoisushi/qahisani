        ...
        <div class="flex overflow-hidden">  <!-- This flex is for contained the nav and the menu -->
            <div class="nav-links duration-500 absolute md:static bg-black min-h-[60vh] md:min-h-fit left-0 top-[-100%] w-full md:w-auto flex items-center px-5">
                <ul class="flex md:flex-row flex-col gap-6 md:items-center md:gap-[4vw]">
                    ...
                    <li><a class="text-mdhamtext font-nunito p-2 hover:text-[#FFE4E0] hover-stroke" href="#about">About</a></li>
                    <li><a class="text-mdhamtext font-nunito p-2 hover:text-[#FFE4E0] hover-stroke" href="#menu">Menu</a></li>
                    <li><a class="text-mdhamtext font-nunito p-2 hover:text-[#FFE4E0] hover-stroke" href="#gallery">Gallery</a></li>
                    <li><a class="text-mdhamtext font-nunito p-2 hover:text-[#FFE4E0] hover-stroke" href="#contact">Contact</a></li>
