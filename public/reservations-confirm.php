...
<body>
    ...
    <main class="bg-gradient-to-tl from-black from-40% to-[#505050] lg:from-[#0A0F12] lg:from-60% lg:to-[#505050] relative reservations-confirm">
            ...
            <div class="grid grid-cols-4 lg:grid-cols-12 pt-10 lg:py-56">
                <div class="col-span-4 lg:col-span-6 z-10">
                    <div class="my-10 lg:my-0">
                        <h1 class="h2 text-white mb-10 md:pt-10 lg:pt-0 lg:mb-8 lg:mt-5">Reservation Confirmed</h1>
